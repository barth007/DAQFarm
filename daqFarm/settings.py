"""
Django settings for daqFarm project.
...
WSGI_APPLICATION = 'daqFarm.wsgi.application'
...
STATICFILES_STORAGE = "daqFarm.settings.IgnoreMissingFilesStorage"
