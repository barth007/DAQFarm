    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elementName', models.CharField(help_text='Name of the element', max_length=50, unique=True, verbose_name='Element Name')),
            ],
        ),
        migrations.CreateModel(
            name='Plot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('naturalGas', models.DecimalField(decimal_places=2, help_text='Natural gas concentration', max_digits=5, verbose_name='Natural Gas')),
                ('sunlight', models.DecimalField(decimal_places=2, help_text='Sunlight intensity', max_digits=5, verbose_name='Sunlight')),
                ('airQuality', models.DecimalField(decimal_places=2, help_text='Air quality of the enviroment', max_digits=5, verbose_name='Air Quality')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Last updated date', verbose_name='Last Updated Date')),
                ('status', models.CharField(default='active', help_text='is the  object active', max_length=20, verbose_name='is_active')),
                ('elementValue', models.DecimalField(blank=True, decimal_places=2, help_text='Value of the element', max_digits=5, null=True, verbose_name='Element Value')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Last updated date', verbose_name='Last Updated Date')),
                ('status', models.CharField(default='active', help_text='is the  object active', max_length=20, verbose_name='is_active')),
                ('batteryStatus', models.DecimalField(decimal_places=2, help_text='Temperature of the board', max_digits=4, verbose_name='Board Temperature')),
                ('solarPanelVoltage', models.DecimalField(decimal_places=2, help_text='Voltage of the solar panel', max_digits=4, verbose_name='Solar panel voltage')),
                ('boardTemperature', models.DecimalField(decimal_places=1, help_text='Battery status percentage', max_digits=4, verbose_name='Battery status')),
                ('plot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='farm_data.plot')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phLevel', models.DecimalField(decimal_places=2, help_text='PH level of the soil', max_digits=5, verbose_name='PH Level')),
                ('electricalConductivity', models.DecimalField(decimal_places=2, help_text='Electrical conductivity of the soil', max_digits=5, verbose_name='Electrical Conductivity')),
                ('exchangeableAcid', models.DecimalField(decimal_places=2, help_text='Exchangeable acidity in the soil', max_digits=5, verbose_name='Exchangeable Acidity')),
                ('plot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='farm_data.plot')),
            ],
            options={
                'abstract': False,
